const data =[
    {
        id: "01",
        name: "Sweet Sunset Tea",
        description: "Ideal for drinking both hot and cold. Rooibos blended with caramel pieces. A sweet, caffeine-free herbal tea with a high mineral and vitamin C content. ",
        price: 5,
        stock: 35,
        category: "Teas and Infusers",
        img: "../img/tea-sweetSunset.png"
    },
    {
        id: "02",
